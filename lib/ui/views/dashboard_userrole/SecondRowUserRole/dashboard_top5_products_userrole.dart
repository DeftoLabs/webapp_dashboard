...
class DashboardTop5ProductByDayUserRole extends StatelessWidget {
  const DashboardTop5ProductByDayUserRole({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<OrdenesProvider>(
      builder: (context, ordenesProvider, child) {
        final top5Productos = ordenesProvider.getTop5ProductsOfTodayByUser(context);
