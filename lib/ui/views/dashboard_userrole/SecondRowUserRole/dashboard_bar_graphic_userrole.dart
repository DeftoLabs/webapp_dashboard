...
class WeeklyOrdersBarChartUserRole extends StatelessWidget {
  const WeeklyOrdersBarChartUserRole({super.key});

  @override
  Widget build(BuildContext context) {
    final weeklyOrderCount = Provider.of<OrdenesProvider>(context).getWeeklyOrderCountByUser(context);
