                                ...
                                return constraints.maxWidth > 530
                                              ...
                                              return SizedBox(
                                                ...
                                                child: DropdownButtonFormField<String>(
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    focusedBorder:const OutlineInputBorder(borderSide: BorderSide(color: Color.fromARGB(255, 28, 28, 29),  width: 2.0,),
                                                    ),
                                                    enabledBorder:const OutlineInputBorder(borderSide: BorderSide(color: Color.fromARGB(255, 28, 28, 29),   width: 2.0,),
                                                    ),
                                                  ),
                                                  icon: const Icon(
                                    ...
                                    : Column(
                                        ...
                                        children: [
                                          ...
                                          fechaentrega != null ? Text(DateFormat('dd/MM/yy') .format(fechaentrega!), style: const TextStyle(color: Colors.white),): const SizedBox.shrink(),
                                          const SizedBox(height: 20),
                                          Consumer<RutaProvider>(
                                            builder:
                                                (context, rutaProvider, child) {
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                  children: [
                                    Text(
                                      currentUser!.uid,
                                      style: const TextStyle(color: Color.fromARGB(255, 28, 28, 29),),
                                    ),
                                    isSmallScreen
                                        ? Column(
                              ...
                              return DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: const OutlineInputBorder(
                                    borderSide: BorderSide(color: Color.fromARGB(255, 28, 28, 29), width: 2.0),
                                  ),
                                      ...
                                      return Column(
                                        children: [
                                          ...
                                          Consumer<ProductsProvider>(
                                            builder: (context, productProvider, child) {
                                              List<Producto> productosOrdenados = List.from(productProvider.productos)
                                              ...
                                              return SizedBox(
                                                ...
                                                child: DropdownButtonFormField<String>(
                                                  ...
                                                  items: productosOrdenados
                                                      .where((producto) => producto.descripcion != null) // Filtra nulos
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    keyboardType: const TextInputType.numberWithOptions(decimal: true),
                                                         validator: (value) {
                                                        if (value == null || value.isEmpty) return localization.selectqunatity;
                                                        if (!RegExp(r'^\d{1,4}(\.\d{0,4})?$').hasMatch(value)) return localization.maxlength4;
                                                        return null;
                                                      },
                                                    onChanged: (value) {
                                                      setState(() {
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                           initialValue:comentario,
                            ...
                            focusedBorder: OutlineInputBorder(
                            borderSide: const BorderSide(color:Colors.white, width: 1),// Color del borde enfocado
                            borderRadius: BorderRadius.circular(8.0),
                            ),
                            errorStyle: const TextStyle(
                              color: Colors.red,
